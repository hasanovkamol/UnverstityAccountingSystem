    ...
    public class Bank:DataModel
    {
        ...
        public List<Bank> banksList()
        {
            return new List<Bank>() {
                new Bank() {BankId=1, Name = "Akfa", Telefon = "997832547", MFO = "123231", Address = "Samarqand" },
                new Bank() {BankId=2, Name = "Akfa", Telefon = "997832547", MFO = "123231", Address = "Samarqand" },
                new Bank() {BankId=3, Name = "Akfa", Telefon = "997832547", MFO = "123231", Address = "Samarqand" }
            };
        }
